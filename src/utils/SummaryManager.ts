...
export const checkAndGenerateSummary = async (
  ...
  errorLog: (msg: string) => void
    ...
    const { apiKey, baseUrl, model, smallSummaryInterval, bigSummaryInterval, smallSummaryPrompt, bigSummaryPrompt } = config
    ...
    // FIX: Remove .sort((a, b) => a.id - b.id) to rely on array order
