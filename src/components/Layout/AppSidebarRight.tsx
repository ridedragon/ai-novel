    ...
    <div className="flex flex-col h-full overflow-hidden">
      <div className="flex border-b border-slate-200 dark:border-[#1e2433] bg-slate-50 dark:bg-[#12151e]/30 p-1 shrink-0 custom-bg-transition">
        <div className="flex gap-1 overflow-x-auto custom-scrollbar pb-1">
          <button onClick={() => { setShowOutline(true); handleSwitchModule('inspiration'); }} className={`flex-1 min-w-[50px] py-2 text-[11px] font-bold rounded-md transition-colors whitespace-nowrap ${creationModule === 'inspiration' ? 'text-[var(--theme-color)] bg-[var(--theme-color)]/10 dark:bg-[var(--theme-color)]/5' : 'text-slate-500 hover:text-slate-800 dark:hover:text-slate-300'}`}>灵感</button>
          <button onClick={() => { setShowOutline(true); handleSwitchModule('worldview'); }} className={`flex-1 min-w-[50px] py-2 text-[11px] font-bold rounded-md transition-colors whitespace-nowrap ${creationModule === 'worldview' ? 'text-[var(--theme-color)] bg-[var(--theme-color)]/10 dark:bg-[var(--theme-color)]/5' : 'text-slate-500 hover:text-slate-800 dark:hover:text-slate-300'}`}>世界观</button>
          <button onClick={() => { setShowOutline(true); handleSwitchModule('characters'); }} className={`flex-1 min-w-[50px] py-2 text-[11px] font-bold rounded-md transition-colors whitespace-nowrap ${creationModule === 'characters' ? 'text-[var(--theme-color)] bg-[var(--theme-color)]/10 dark:bg-[var(--theme-color)]/5' : 'text-slate-500 hover:text-slate-800 dark:hover:text-slate-300'}`}>角色</button>
          <button onClick={() => { setShowOutline(true); handleSwitchModule('plotOutline'); }} className={`flex-1 min-w-[50px] py-2 text-[11px] font-bold rounded-md transition-colors whitespace-nowrap ${creationModule === 'plotOutline' ? 'text-[var(--theme-color)] bg-[var(--theme-color)]/10 dark:bg-[var(--theme-color)]/5' : 'text-slate-500 hover:text-slate-800 dark:hover:text-slate-300'}`}>粗纲</button>
          <button onClick={() => { setShowOutline(true); handleSwitchModule('outline'); }} className={`flex-1 min-w-[50px] py-2 text-[11px] font-bold rounded-md transition-colors whitespace-nowrap ${creationModule === 'outline' ? 'text-[var(--theme-color)] bg-[var(--theme-color)]/10 dark:bg-[var(--theme-color)]/5' : 'text-slate-500 hover:text-slate-800 dark:hover:text-slate-300'}`}>章节</button>
          <button onClick={() => { setShowOutline(true); handleSwitchModule('reference'); }} className={`flex-1 min-w-[50px] py-2 text-[11px] font-bold rounded-md transition-colors whitespace-nowrap ${creationModule === 'reference' ? 'text-[var(--theme-color)] bg-[var(--theme-color)]/10 dark:bg-[var(--theme-color)]/5' : 'text-slate-500 hover:text-slate-800 dark:hover:text-slate-300'}`}>资料</button>
        </div>
      </div>
