...
export const ChapterEditor: React.FC<ChapterEditorProps> = React.memo(({
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0">
      {/* Toolbar */}
      <div className="h-14 md:h-16 px-1.5 md:px-10 border-b border-slate-200 dark:border-white/5 flex flex-row items-center justify-between bg-white dark:bg-[#09090b] shrink-0 gap-0.5 md:gap-0 custom-header-transition overflow-hidden">
