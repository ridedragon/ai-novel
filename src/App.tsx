    ...
    <NovelEditorLayout
      headerLeft={
        <>
          ...
          <button className="flex items-center gap-2 px-2 md:px-3 py-1.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-white/5 hover:border-slate-300 dark:hover:border-slate-600 rounded-lg transition-all text-[11px] text-slate-600 dark:text-slate-300" onClick={() => setShowAdvancedSettings(true)}>
      ...
      headerRight={
        <div className="flex items-center gap-0.5 md:gap-1 bg-white/50 dark:bg-slate-800/40 px-0.5 md:px-2 py-1 rounded-xl border border-slate-200 dark:border-white/5">
          ...
          >
            ...
            <span className="hidden md:inline">长文模式</span>
            {longTextMode && (
              <select
                value={contextScope}
      ...
      sidebarLeft={
        <>
          <div className="p-5 flex items-center justify-between shrink-0">
            <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 tracking-[0.2em] uppercase">Chapters ({chapters.length})</span>
